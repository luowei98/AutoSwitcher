...
namespace AutoSwitcher.Window.Api
{
    ...
    public static class WindowsListFactory
    {
	    ...
	    private static bool IsKnownException(IWindowEntry window)
	    {
	        ...
	        var exception = Properties.Settings.Default.ExceptionWindows;
            if (exception.Contains(window.ProcessName))
                return true;
        ...
        private static IntPtr GetLastVisibleActivePopUpOfWindow(IntPtr window)
        {
            ...
            Debug.Print($"Could not find last active popup for window {window} after {MaxLastActivePopupIterations} iterations");
            return IntPtr.Zero;
        }
    }
}
